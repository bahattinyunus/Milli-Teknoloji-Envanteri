# 🚜 Proje: BARKAN (Orta Sınıf İnsansız Kara Aracı)

![BARKAN](../../../_ASSETS/hero_banner.png)

> **"Dijital Birliğin Karadaki Gözü: Yarının Otonom Savaşçısı"**
...
| :--- | :--- | :--- |
| **Tür** | Orta Sınıf İnsansız Kara Aracı (İKA) | Modüler Gövde Yapısı |
| **Silah Sistemi** | 7.62mm SARP-L UKSS | Uzaktan Komutalı veya Otonom |
| **Hız** | 12+ km/s | Yüksek Arazi Kabiliyeti |
| **Kullanım Süresi** | 8+ Saat | Elektrikli Tahrik Sistemi |
| **Sensör Paketi** | LIDAR, Termal ve Gündüz Kameraları | 360 Derece Farkındalık |

## 🕹️ Otonom Yetenekler ve Dijital Birlik
BARKAN, tek başına görev yapabildiği gibi HAVELSAN'ın "Karma Sürü" mimarisine tam entegredir:
- **Otonom Keşif:** Belirlenen rotada engel sakınarak bağımsız devriye.
- **Dijital Birlik Entegrasyonu:** BAHA (İHA) ve diğer sistemlerle gerçek zamanlı veri paylaşımı.
- **Lider - Takipçi Modu:** İnsanlı araçları veya personeli otonom takip.

## 📦 Varyantlar ve Görev Setleri
...
- [x] Saha Testleri ve Atış Gösterimleri
- [x] TSK Envanterine Geçici Kabul
