# ✈️ Proje: ANKA-3 (İnsansız Savaş Uçağı - Uçan Kanat)

![ANKA-3](../../../_ASSETS/hero_banner.png)

> **"Görünmez Kanatlar, Sessiz Darbe: Derin Harekatın Mimarı"**
...
| :--- | :--- | :--- |
| **Rol** | Derin Darbe / SEAD-DEAD / İSR | Stealth Mimari |
| **Servis İrtifası** | 40.000 ft | Uzun Süreli Havada Kalış |
| **Hız** | 0.7 Mach (Yüksek Subsonik) | Jet Motorlu Tahrik |
| **Faydalı Yük** | 1.200 kg (Dahili Silah İstasyonları) | Radarda Düşük Görünürlük |
| **Sevk Sistemi** | Turbofan Motor | Yüksek Güç Kapasitesi |

## 🛡️ Stealth ve Operasyonel Profil
ANKA-3, tasarımının sağladığı avantajlarla düşman hava savunma radarları tarafından tespit edilmesi en güç platformlardan biridir:
- **Dahili Silah İstasyonları:** Mühimmatın içeride taşınması sayesinde radar kesit alanı minimumda tutulur.
- **SEAD/DEAD Görevleri:** Düşman hava savunma sistemlerini etkisiz hale getirme.
- **Elektronik Harp:** Stratejik noktalara sızma ve EH operasyonları.
...
- [x] İlk Taksi Testleri
- [x] Tarihi İlk Uçuş (28 Aralık 2023)
- [/] Tam Donanımlı Sistem Testleri
